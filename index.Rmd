...
+ **(__OJO AÑADIR AQUI EL SIGIFICADO DE LAS VARIABLES__)**
...
+ **(__OJO AÑADIR AQUI LAS VARIABLES DE LAS COLUMNAS DE LOS DATAFRAMS Y OTROS DETALLES__)**
...
### 5. Limpieza de los datos elegantes
...
*Puntuación*: Para obtener la puntuacion dimos a cada version de TLS una puntuacion:
...
En el caso de la denominada puntuación, se trata de un valor porcentual que muestra, del total de dispositivos del país en cuestión, que tanto por ciento representa el protocolo al que hace referencia (*__FAVOR REVISAR SI MI DESCRIPCIÓN ES LA CORRECTA__*)
Así, las cosas, se obtiene la siguiente tabla de datos:
(*__AQUI ROBERTO VA A INCORPORAR EL PRINTSCREEN DE LA ESTRUCTURA__*)

### 6. Análisis de exploración de datos

**__AQUI CREO QUE IRIA LA PARTE DE CODIGO__**

### 7. Modelos o predicciones estadísticas

### 8. Interpretación de resultados

Para la interpretacion de los resultados decidimos pintar los datos en un mapamundi. De aqui pudimos obtener algunas importantes conclusiones y aproximarmos a la respuesta de la cuestion que nos planteabamos:
...
En el grafico se puede ver en verde los paises que tienen menos riesgo, mientras en rojo se pintan aquellos que tienen las versiones de TLS mas desacualiadas y por tanto mas vulnerables.

### 9. Respuesta a la pregunta

### 10. Síntesis y descripción de resultados
